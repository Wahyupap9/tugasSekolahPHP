...
<html lang="en">
  ...
  <body>
    <h1 class="title-data">Data Kelas</h1>
    <!-- search -->
        ...
        <table border='1' cellspacing="0" cellpadding="10">
            ...
            <?php foreach($box as $item) :?>
                ...
                <!-- <h1><?=var_dump($box);?></h1> -->
                    ...
                    <td class="button"><a href="editKelas.php?id=<?=$item['id'];?>"><i class="ri-edit-2-line"></i></a>
                                        <a href="delete.php?id=<?=$item['id']; ?>&data=data_kelas"><i class="ri-delete-bin-fill"></i></td></a>
                </tr>
            <?php endforeach; ?>
        </table>
    </div>
