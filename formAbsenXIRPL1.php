...
<body>
    <h1 class="title-page">Absen Siswa XI RPL 1</h1>
                    ...
                    <tr>
                        ...
                        <td class="absen">
                            <div class="list-absen-item">
                                <input type="radio" class="absen hadir"  name="data_<?=$i;?>" value="H" for="H" required>
                                <label for="H">Hadir</label>
                            </div>
                            
                            <div class="list-absen-item">
                                <input type="radio" class="absen" name="data_<?=$i;?>" value="TH" for="TH" required>
                                <label for="TH">Tidak Hadir</label>
                            </div>

                            <div class="list-absen-item">
                                <input type="radio" class="absen" name="data_<?=$i;?>" value="S" for="S" required>
                                <label for="S">Sakit</label>
                            </div>

                            <div class="list-absen-item">
                                <input type="radio" class="absen" name="data_<?=$i;?>" value="I" for="I" required>
    ...
    <script src="main.js">console.log("aa");
    </script>
</body>
</html>